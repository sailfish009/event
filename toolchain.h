...
#define MBED_PACKED(struct) struct __declspec(packed)
#else
...
#elif defined(_MSC_VER)
#define MBED_ALIGN(N) __declspec(aligned(N))
#else
...
#elif defined(_MSC_VER)
#define MBED_UNUSED __declspec(__unused__)
#else
#define MBED_UNUSED
#endif
#endif
...
#elif defined(_MSC_VER)
#define MBED_WEAK __declspec(selectany)
#else
...
#elif defined(_MSC_VER)
#define MBED_PURE __declspec(const)
#else
#define MBED_PURE
#endif
#endif
...
#elif defined(_MSC_VER)
#define MBED_FORCEINLINE static inline __declspec(always_inline)
...
#elif defined(_MSC_VER)
#define MBED_NORETURN __declspec(noreturn)
#elif defined(__ICCARM__)
...
#elif defined(_MSC_VER)
#define MBED_DEPRECATED(M) __declspec(deprecated(M))
...
#elif defined(_MSC_VER)
#define MBED_CALLER_ADDR() _ReturnAddress()
